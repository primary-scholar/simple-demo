...
import com.mimu.simple.java.seriali.model.ViVoSourceMaterialVO;
...
public class FastJsonTest {
    ...
    public void test3() throws InterruptedException {
        ViVoSourceMaterialVO dataVO = new ViVoSourceMaterialVO();
        ViVoSourceMaterialVO.ViVoSourceMaterialItemVO element = new ViVoSourceMaterialVO.ViVoSourceMaterialItemVO();
        element.setText("text");
        element.setHotText("hotText");
        element.setUrl("url");
        element.setDeeplink("deeplink");
        dataVO.setItemList(List.of(element));

        ApiResult<ViVoSourceMaterialVO> apiResult = ApiResultUtil.success(dataVO);
