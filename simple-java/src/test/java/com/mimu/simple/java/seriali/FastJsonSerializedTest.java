...
public class FastJsonSerializedTest {
    ...
    public void info() {
        ...
        FastJsonFeaturePeople javaObject = JSONObject.parseObject(jsonObject.toString(), FastJsonFeaturePeople.class);
    ...
    public void info1() {
        ...
        FastJsonFeaturePeople javaObject = JSONObject.parseObject(peos, FastJsonFeaturePeople.class);
        System.out.println(javaObject);

        String peos1 = "{\"bName\":\"bnamela\",\"age\":12}";
        FastJsonFeaturePeople object = JSONObject.parseObject(peos1, FastJsonFeaturePeople.class);
    ...
    public void tempModel2Test() {
        ...
        System.out.println(String.format(url, 843528,
                        JSONObject.toJSONString(video, JSONWriter.Feature.WriteBigDecimalAsPlain),
                JSONObject.toJSONString(article, JSONWriter.Feature.WriteBigDecimalAsPlain)));
    }
