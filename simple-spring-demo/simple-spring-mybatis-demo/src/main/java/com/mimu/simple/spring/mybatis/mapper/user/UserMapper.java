package com.mimu.simple.spring.mybatis.mapper.user;

import com.mimu.simple.spring.mybatis.model.user.UserData;
import com.mimu.simple.spring.mybatis.model.user.UserDataResultMap;
import com.mimu.simple.spring.mybatis.model.user.UserDataVo;
 ...
 * 会 扫描到指定包 下的所有mapper 并把 扫描到的 mapper 解析成 beanDefinition,在 ClassPathMapperScanner 扫描类时，
 * 会同时指定该 definition 中的 beanClass 为 MapperFactoryBean<T>(one of  FactoryBean) 这样 在 @autowire
